...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > Sodiq Tunneling${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}sodiq-tunnel� ${NC}${YELLOW}(${NC} ${green} 🇮🇩sodiq store🇮🇩  ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self sodiqProject ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/shodiq7/Apex/ZX/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/shodiq7/Apex/ZX/REGISTRASI"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/shodiq7/Apex/ZX/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
